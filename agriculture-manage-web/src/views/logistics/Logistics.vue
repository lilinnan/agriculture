      ...
      <template v-slot:top>
        <v-toolbar flat rounded>
          ...
          <v-text-field
              ...
              hide-details
          ></v-text-field>
          <v-dialog v-model="dialogInfo.editOrAddDialog" max-width="360" persistent>
                ...
                <v-container>
                  <v-form ref="form">
                    <v-text-field
                        ...
                        autocomplete="off"
                        label="物流名称"
                        v-model="editOrAddData.logisticsName"
                        :rules="editRules.logisticsNameRule"
                        required
                    ></v-text-field>
                  </v-form>
                </v-container>
...
export default {
  ...
  methods: {
    ...
    startEdit(item) {
      ...
      this.editOrAddData.logisticsName = item['name'];
    },
    startAdd() {
    ...
    save() {
      ...
      let data = {
        name: this.editOrAddData.logisticsName
      }
