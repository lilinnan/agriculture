package com.lln.agriculture.user.security.config;

import com.lln.agriculture.user.security.filter.JwtTokenVerifierFilter;
import com.lln.agriculture.user.security.filter.JwtUsernamePasswordAuthenticationFilter;
import com.lln.agriculture.user.security.handler.SimpleAccessDeniedHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/v1/user-info/register/**").permitAll()
                .antMatchers("/v1/user-info/password/find/**").permitAll()
                .antMatchers("/v1/item/spu/**").permitAll()
                .antMatchers("/v1/order/async-check-pay-result").permitAll()
                .antMatchers("/v1/agriculture/**").permitAll()
