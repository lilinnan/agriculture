...
import com.lln.agriculture.user.security.config.bean.JwtConfig;
...
public class JwtServiceImpl implements JwtService {
    ...
    public String signNewJwt(String subject, String claimName, Object claimValue) {
        return signNewJwt(subject, claimName, claimValue, jwtConfig.getSignatureValidTime());
    }

    @Override
    public String signNewJwt(String subject, String claimName, Object claimValue, long time) {
        long signatureExpirationTime = System.currentTimeMillis() + time;
        return Jwts.builder()
                .setSubject(subject)
